...
-- 1. string to yyyy-mm-dd

select 	
	to_date('2021-10-15', 'yyyy-mm-dd')

select to_date('20211215', 'yyyymmdd')

select to_date('01-12-2025', 'dd-mm-yyyy')

select to_date('1 january 2024', 'dd month yyyy')

select to_date('8th december, 2025', 'ddth month, yyyy')

-- Using to_timestamp function

select to_timestamp('2025-01-01 10:45:00', yyyy-mm-dd 'hh:mi:ss')
